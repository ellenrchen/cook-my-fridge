...
interface IngredientInputProps {
  onSubmit: (ingredients: string, diet: DietaryPreference, maxTime: MaxCookTime) => void;
  isLoading?: boolean;
}

const quickAddIngredients = [
  "eggs", "rice", "chicken breast", "tomatoes", "onions", 
  "garlic", "spinach", "pasta", "cheese", "potatoes"
];
